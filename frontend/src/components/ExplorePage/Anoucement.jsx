  ...
  return (
    <section className='flex gap-1 w-[99.8%] '>
        ...
        <div className=' bg-white  p-5'>
            <p className=' text-lg font-[var(--title-font)] text-gray-400 '>Every month, we bring you unbeatable discounts on premium vehicles to help you drive in style for less.
