...
const Reasons = () => {
  return (
    <div className='flex gap-5 my-5 w-full h-full '>
            ...
            >
              <img src={FeatureImage} alt="" className='bg-center bg-cover rounded-2xl ' data-aos="fade-right" data-aos-duration="3000"/>
            </div>  
            <div className='w-[60%]' data-aos="fade-left" data-aos-duration="3000">
